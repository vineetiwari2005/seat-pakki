...
public class MovieTransformer {
    ...
    public static Movie movieDtoToMovie(MovieEntryDto movieEntryDto) {
        Movie movie = Movie.builder()
                ...
                .cast(movieEntryDto.getCast())
                .posterUrl(movieEntryDto.getPosterUrl())
                .trailerUrl(movieEntryDto.getTrailerUrl())
                .nowShowing(movieEntryDto.getNowShowing() != null ? movieEntryDto.getNowShowing() : true)
                .build();
